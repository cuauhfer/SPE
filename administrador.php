...
?>
	...
	<body>
		<header class="fixed-top">
			<nav>
				<ul>
					<a id="header" href='persona.php'><li>Perfil</li></a>
					<a id="header" href='admin_usuario.php'><li>Usuarios</li></a>
					<a id="header" href='mis_publicaciones.php'><li>Publicaciones</li></a>
				...
				<ul>
					<a id="header" href='notificacion.php'><li>Pendientes
						<?php  
					...
					<a id="header" href='log.php'><li>Logs</li></a>
   					<a id="header" href='logout.php'><li>Salir</li></a>
				</ul>
			</nav>
		</header>
		...
		<section>
			...
			<div class="container-fluid">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
		  			<li class="nav-item">
		    			<a class="nav-link text-success active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Todo</a>
		  			</li>
				  	<li class="nav-item">
				    	<a class="nav-link text-success btn" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Lo más reciente</a>
				  	</li>
		  			<li class="nav-item">
		    			<a class="nav-link text-success btn" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Contacto</a>
		  			</li>
				</ul>
			</div>
			...
			<div class="tab-content container-fluid" id="myTabContent">
	  			...
	  			<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
	  				<div class="row">
		              		...
		              		<div class="card mb-4 box-shadow">
		                		...
		                		<div class="card-body">
		                			<h3 class="text-center">Crear publicación</h3>
		                  			<p class="card-text">Bienvenido integrante, puedes comenzar a publicar entrando aquí.</p>
		                  			<div class="d-flex justify-content-between align-items-center">
		                    			<div class="btn-group">
		                      				<a href="int_produccion.php"><button type="button" class="btn btn-sm btn-outline-success">Publicar</button></a>
		                    			</div>
		                    			<small class="text-muted">
		                    				<?php  
												echo $total." publicaciones existentes";
											?>
		                    			</small>
		                  			</div>
		                		</div>
		            	...
		            	<div class="col-md-4">
		              		<div class="card mb-4 box-shadow">
		                		<img class="card-img-top" src="pictures/alumnos.jpg" width="200" height="200" alt="Card image cap">
		                		<div class="card-body">
		                  			...
		                  			<div class="d-flex justify-content-between align-items-center">
		                    			...
		                    			<small class="text-muted">
		                    				<?php  
												...
												$resultado = mysqli_query($conexion, $sql);
												$pendiente = $resultado -> num_rows;
												echo $pendiente." alumnos registrados";
											?>
		                    			</small>
		                  			</div>
		                		</div>
					        ...
					        <div class="col-md-6">
					          	<div class="card flex-md-row mb-4 box-shadow h-md-250">
						            ...
						            <div class="card-body d-flex flex-column align-items-start">
						              	...
						              	<?php 
							              	echo "<a href='estadia_ind.php/?nombre=".$reg['id']."&autor=".$reg['codigoPersona']."' class='btn-outline-success'>Ver más</a>";
							            ?>
						            </div>
					          	...
					          	<div class="card flex-md-row mb-4 box-shadow h-md-250">
						            ...
						            <div class="card-body d-flex flex-column align-items-start">
						              <strong class="d-inline-block mb-2 text-primary">Estadía</strong>
						              	...
						              	<?php 
							              	echo "<a href='estadia_ind.php/?nombre=".$reg2['id']."&autor=".$reg2['codigoPersona']."' class='btn-outline-success'>Ver más</a>";
							            ?>
						            </div>
					          	</div>
					        </div>
